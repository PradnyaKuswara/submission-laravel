...
@section('content')
    <div class="max-w-screen-xl mx-auto pt-28 pb-32 md:pb-40 p-5">
        <div>
            <h1 class="sans text-xl text-extrabold animate__animated animate__fadeInDown">Edit Category</h1>
        </div>
                    ...
                    <div class="grid md:grid-cols-2 mt-4 gap-x-4 gap-y-6">
                        <div class="md:col-span-2 mt-4">
                            ...
                            <input type="text" name="category_name" aria-describedby="helper-text-explanation"
                                ...
                                placeholder="Category name" autocomplete="off" value="{{ $data->category_name }}">
                            @error('category_name')
